...
bot = telebot.TeleBot("6820227172:AAGIy310WfkuKx6Ar4a22xUGtl4lUm2A7xc",
...
text_button_1 = "Ваше имя"  # Можно менять текст
text_button_2 = "Ваша фамилия"  # Можно менять текст
text_button_3 = "Опишите кратко ваш опыт"  # Можно менять текст
